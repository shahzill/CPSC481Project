...
function MenuPage() {
  ...
  const specificFoodItem =
    foodItems.find((foodItem) => foodItem.id === 2) || null;
  const Soups = foodItems.filter((foodItem) => foodItem.Course === "Soups");
  const Appetizers = foodItems.filter(
    (foodItem) => foodItem.Course === "Appetizers"
  );
  const Salad = foodItems.filter((foodItem) => foodItem.Course === "Salad");
  const Fish = foodItems.filter((foodItem) => foodItem.Course === "Fish");
  const MainCourse = foodItems.filter(
    (foodItem) => foodItem.Course === "Main course"
  );
  const PalateCleasner = foodItems.filter(
    (foodItem) => foodItem.Course === "Palate cleanser"
  );
  const Dessert = foodItems.filter(
    (foodItem) => foodItem.Course === "Desserts"
  );
          ...
          <div className="menu">
            ...
            <div className="menu-items">
              <div className="food-items-courses">
                <div className="food-items-courses-header">Soups</div>
              ...
              <div className="food-items-courses">
                <div className="food-items-courses-header">Appetizers</div>
                <div className="food-items-courses-items">
              ...
              <div className="food-items-courses">
                <div className="food-items-courses-header">Salad</div>
                <div className="food-items-courses-items">
              ...
              <div className="food-items-courses">
                <div className="food-items-courses-header">Fish</div>
                <div className="food-items-courses-items">
                  {Fish.map((item, index) => (
                    <Link
                      className="food-link"
              ...
              <div className="food-items-courses">
                <div className="food-items-courses-header">Main Course</div>
                <div className="food-items-courses-items">
              ...
              <div className="food-items-courses">
                <div className="food-items-courses-header">Palate Cleasner</div>
                <div className="food-items-courses-items">
              ...
              <div className="food-items-courses">
                <div className="food-items-courses-header">Desserts</div>
                <div className="food-items-courses-items">
              ...
              <div className="food-items-courses">
                <div className="food-items-courses-header">Drinks</div>
                <div className="food-items-courses-items">
